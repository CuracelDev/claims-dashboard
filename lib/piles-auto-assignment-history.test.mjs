...
const page = {};
new Function('require', 'exports', `${compiled}\nexports.HistoryRun = typeof RunnerHistoryRun === 'undefined' ? undefined : RunnerHistoryRun; exports.HistorySection = RunnerHistorySection; exports.Control = RunnerControlSection;`)((name) => {
  if (name.endsWith('/piles-auto-assignment-history.mjs')) return history;
  if (name.endsWith('/ThemeContext') || name.endsWith('/auth')) return {};
  return require(name);
}, page);
const C = { card: '#111827', elevated: '#1A2332', border: '#1E2D3D', text: '#F0F4F8', sub: '#8899AA', success: '#34D399', danger: '#FF5C5C', warn: '#FFB84D', blue: '#5B8DEF' };
