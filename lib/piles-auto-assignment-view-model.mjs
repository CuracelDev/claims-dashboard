...
function previewInsurers(run, source, now) {
  ...
  return values.map((item, index) => {
    ...
    }, [{ insurer_run_id: syntheticId, status: 'complete', distinct_pile_count: item?.discovered_piles,
      unassigned_pile_count: item?.discovered_piles, claim_count: item?.discovered_claims }], [],
