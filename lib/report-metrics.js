...
export function normalizeReportDate(value, fallback = null) {
...
export function formatDailyReportDate(value, options = {}, fallback = 'Unknown date') {
  const dateKey = normalizeReportDate(value);
...
export function normalizeDailyReport(report) {
  ...
  return {
    ...report,
    report_date: normalizeReportDate(report.report_date, report.report_date),
