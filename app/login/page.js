...
// app/login/page.js
// Claims Intel — Login
// Name card grid → PIN entry → server session → redirect
// Guest: Continue as Guest → guest session → redirect to /
...
export default function LoginPage() {
  ...
  // Skip login if session already valid
  useEffect(() => {
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: 36 }}>
        ...
        <div style={{ fontSize: 12, color: C.sub, marginTop: 4 }}>Curacel Health Ops</div>
      </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 30 }}>
              ...
              <div style={{
                ...
                background: selected.colour + '20',
                border: `2px solid ${selected.colour}`,
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: 14, fontWeight: 700, color: selected.colour,
                flexShrink: 0,
              }}>
                {selected.initials}
              </div>
              <div>
                ...
                <div style={{ fontSize: 12, color: C.sub }}>Enter your PIN to continue</div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              {error && (
                <div style={{
                  fontSize: 12, color: C.danger, marginTop: 7,
...
function MemberCard({ member, onSelect }) {
  ...
  const C_border = '#1E2D45';
  const C_elevated = '#1A2A3F';
  const C_text = '#E8EEF7';
  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1px solid ${hovered ? member.colour : C_border}`,
